...
# Loading the Data
df_campaign_data = pd.read_parquet(r"..\data\marketing_department\campaign_data_separated.parquet")
...
### Saving data
df_campaign_data.to_parquet(r"..\data\marketing_department\campaign_data_removed_symbols.parquet")

...
# Load data
df_droped_duplicates = pd.read_parquet(os.path.join('..', 'data_pipeline_operations_department_07_droped_duplicates', 'data_pipeline_operations_department_07_droped_duplicates.parquet'))

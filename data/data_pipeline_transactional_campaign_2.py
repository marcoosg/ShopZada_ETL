...
# Loading the Data
df_transaction_campaign_data = pd.read_parquet(r"C:\Users\arian\final\data\enterprise_department\parquet\transactional_camapaign_renamed.parquet")
...
### Saving data
df_transaction_campaign_data.to_parquet(r"C:\Users\arian\final\data\enterprise_department\parquet\transactional_camapaign_column.parquet")

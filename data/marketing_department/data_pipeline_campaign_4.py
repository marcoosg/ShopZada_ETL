...
# Loading the Data
df_campaign_data = pd.read_parquet(r"C:\Users\arian\final\data\enterprise_department\parquet\campaign_data_renamed.parquet")
...
### Saving data
df_campaign_data.to_parquet(r"C:\Users\arian\final\data\enterprise_department\parquet\campaign_data_uppercase.parquet")
